...
input_path = "data/bird_data/bird1.png"
weights_path = "feathersnap.weights"
data_file = "cfg/coco.data"
config_file = "cfg/yolov4.cfg"
thresh = 0.25
save_labels = False
ext_output = False  # display bbox coordinates of detected objects
dont_show = False  # window inference display. For headless systems
batch_size = 1
...
def check_arguments_errors(args):
    ...
    if input_path and not os.path.exists(input_path):
        raise (ValueError("Invalid image path {}".format(os.path.abspath(input_path))))
